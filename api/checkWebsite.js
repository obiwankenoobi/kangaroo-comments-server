...
/**
 ** @ { function } checkIfWebsiteExist - fucntion to check if there is already website with a given name - the call came from commentsPanel when the user trying to add new website
 */
